---
title: Alipay
description: Step-by-step guide to adding your Solayer Pay to Alipay for seamless payments in China.
---

# How to Add Solayer Pay to Alipay

Solayer Pay is a Visa card issued internationally, and it can be added to Alipay for seamless payments at supported merchants and platforms. This guide walks you through each step using the actual Alipay interface.
...
- Since Solayer Pay is an international bank card, Alipay may restrict further payments once your cumulative spending reaches **15,000 CNY**.
