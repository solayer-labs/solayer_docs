---
title: "Solayer API endpoint"
---

# Solayer API endpoint 
...
| **tvl_sol**       | String/Number | Total TVL of the protocol denominated in SOL.                               |
| **tvl_usd**       | String/Number | Total TVL of the protocol in USD.                                           |
