...
When registering for Solayer Pay during the KYC (Know Your Customer) process, you will need to select an occupation code that best describes your profession. Below is a comprehensive list of all available occupation codes for your reference. You can also download the complete [Occupation Codes PDF](/Occupation-Codes.pdf) for offline reference.
