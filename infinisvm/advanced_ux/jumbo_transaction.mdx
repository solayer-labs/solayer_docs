...
To enable **high-complexity transaction logic**, especially for **hook-based transactions**, **Solayer Chain** introduces **jumbo transactions**. This new transaction type **extends the transaction size limit**, allowing for **greater cross-program execution capacity** within a single atomic transaction.

<br />

## **What Are Jumbo Transactions?**

A **jumbo transaction** is an **enhanced transaction type** in **Solayer Chain** that enables:
