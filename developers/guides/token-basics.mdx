...
sidebarTitle: "Deploy Token On Mainnet"
---
...
### 2. Configure Solana CLI for Solayer Network

#### For Production (Mainnet)

```bash
# Set cluster to Solayer mainnet
...
```bash
# Set cluster to Solayer devnet (for testing)
...
<Note>
The following airdrop commands are for **devnet testing only**. On mainnet, you'll need to fund your wallet with real SOL through exchanges or other methods.
</Note>
...
# Request airdrop (devnet only - you will have to repeat this process till your wallet has enough balance)
solana airdrop 1
...
**Note**: Ensure you have at least 1-2 SOL for token creation and operations. The airdrop feature is only available on devnet for testing purposes.
