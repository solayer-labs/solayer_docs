...
You acknowledge and agree that you have read and understood the Solayer prohibited activities list (https://docs.solayer.org/resources/legal/prohibitions) and that you will not engage in any such activities when using the Services or the Solayer Card.  
