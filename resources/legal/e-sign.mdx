...
Your affirmative consent to this E-sign & Electronic Communications Notice ("Consent") permits Us to provide you such Communications electronically, enables you to sign and authorize Communications electronically through the use of the Dashboard or API's provided by Rain (the "Dashboard", "Platform" or "Service"), and allows Rain and its partners to collect such e-signings. If you do not consent to electronic delivery of Communications, you will not be able to use the Service. 
