...
Solana’s stablecoin ecosystem is growing rapidly, attracting new assets and demonstrating strong confidence in its infrastructure.

To build on this momentum, we’ve created sUSD — a yield-bearing stablecoin designed to enhance utility within the Solana network.
...
sUSD is uniquely positioned as a yield-bearing, T-bill-backed stablecoin on Solana, with applications as a payment method, trading asset, collateral asset, and more.
...
Ultimately, we envision sUSD becoming the on-chain liquidity layer, bridging fiat systems to the on-chain economy.
