...
You acknowledge and agree that you have read and understood the Solayer prohibited activities list (https://www.solayer.org/legal/docs/prohibitions) and that you will not engage in any such activities when using the Services or the Solayer Card.  
