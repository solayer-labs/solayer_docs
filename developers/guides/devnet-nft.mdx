---
title: "Deploying an NFT on Solayer"
sidebarTitle: "Deploy NFT On Mainnet"
---
...
<Note>
This guide uses the **devnet RPC endpoint** (`https://devnet-rpc.solayer.org`) which is specifically for **devnet and testing purposes only**. For production NFT deployments, use the mainnet RPC endpoint: `https://mainnet-rpc.solayer.org`
</Note>
...
(async () => {
  ...
  // 3. Configure CLI to Devnet (for testing)
  // Note: Use https://mainnet-rpc.solayer.org for production
...
![NFT CLI Ouput1](/images/dev-tutorials/nft-cli-output1.png)

![NFT CLI Ouput2](/images/dev-tutorials/nft-cli-output2.png)
